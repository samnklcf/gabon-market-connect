        ...
        <div className="max-w-md mx-auto">
          <Card className="shadow-xl">
            <CardHeader className="text-center">
              ...
              <p className="text-gray-600">Accédez à votre compte GabMarketHub</p>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="#" className="text-sm text-gabon-green hover:underline">
                    Mot de passe oublié ?
                  </Link>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600">
                  ...
                  <Link to="/register" className="text-gabon-green hover:underline font-semibold">
                    Créer un compte
                  </Link>
                </p>
              </div>
